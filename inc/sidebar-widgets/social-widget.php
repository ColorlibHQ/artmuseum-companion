...
esc_html__( '[ Art Museum ] Social Widget', 'artmuseum-companion' ),

// Widget description
array( 'description' => esc_html__( 'Add social content', 'artmuseum-companion' ), ) 
);
...
if ( isset( $instance[ 'title' ] ) ) {
	...
	$title = esc_html__( 'Follow Us', 'artmuseum-companion' );
}
