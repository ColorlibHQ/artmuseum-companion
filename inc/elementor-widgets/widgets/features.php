...
class Artmuseum_Features extends Widget_Base {
	...
	public function get_title() {
		return __( 'Features', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'features_content',
            [
                'label' => __( 'Features', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'features', [
                'label' => __( 'Create Features', 'artmuseum-companion' ),
                'type' => Controls_Manager::REPEATER,
                'title_field' => '{{{ label }}}',
                'fields' => [
                    [
                        'name' => 'label',
                        'label' => __( 'Title', 'artmuseum-companion' ),
                    ...
                    [
                        'name' => 'fonticon',
                        'label' => __( 'Font Icon', 'artmuseum-companion' ),
                        'type' => Controls_Manager::ICON,
                    ],
                    [
                        'name' => 'desc',
                        'label' => __( 'Descriptions', 'artmuseum-companion' ),
                        'type' => Controls_Manager::WYSIWYG,
                    ],
                    [
                        'name' => 'hovdesc',
                        'label' => __( 'Hover Descriptions', 'artmuseum-companion' ),
                        'type' => Controls_Manager::TEXTAREA,
                    ],
                    [
                        'name' => 'btntitle',
                        'label' => __( 'Button Label', 'artmuseum-companion' ),
                        'type' => Controls_Manager::TEXT,
                    ],
                    [
                        'name' => 'url',
                        'label' => __( 'Button Url', 'artmuseum-companion' ),
                        'type' => Controls_Manager::TEXT,
                    ]
                ],
            ]
        ...
        $this->start_controls_section(
            'style_features', [
                'label' => __( 'Style Features', 'artmuseum-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Font Icon', 'artmuseum-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_fonticon', [
                'label'     => __( 'Font Icon Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'fontsize',
            [
                'label' => __( 'Icon Font Size', 'artmuseum-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Descriptions', 'artmuseum-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Descriptions Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_hovservices', [
                'label' => __( 'Style Hover Services', 'artmuseum-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'color_btntextcolor', [
                'label'     => __( 'Button Text Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-service .overlay .text p' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            'color_btntexthovercolor', [
                'label'     => __( 'Button Text Hover Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-service .overlay .text p' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            'color_btnbgcolor', [
                'label'     => __( 'Button Background Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-service .overlay .text p' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_control(
            'color_btnhovbgcolor', [
                'label'     => __( 'Button Hover Background Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .single-service .overlay .text p' => 'color: {{VALUE}};',
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Background', 'artmuseum-companion' ),
                'types' => [ 'gradient' ],
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Hover Service Box Background Color ', 'artmuseum-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => __( 'Style Service Box Border Color ', 'artmuseum-companion' ),
                'type'      => \Elementor\Controls_Manager::HEADING,
                'separator' => 'before',
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Border', 'artmuseum-companion' ),
                'selector' => '{{WRAPPER}} .single-product',
            ]
        );
		$this->end_controls_section();
