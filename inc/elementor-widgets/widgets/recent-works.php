...
class Artmuseum_Recent_Works extends Widget_Base {
	...
	public function get_title() {
		return __( 'Recent Works', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'recentwork_heading',
            [
                'label' => __( 'Recent Work Section Heading', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'recentwork_content',
			[
				'label' => __( 'Gallery', 'artmuseum-companion' ),
			]
		);
        $this->add_control(
            'recentworks', [
                'label' => __( 'Create Work', 'artmuseum-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'col',
                        'label' => __( 'Column', 'artmuseum-companion' ),
