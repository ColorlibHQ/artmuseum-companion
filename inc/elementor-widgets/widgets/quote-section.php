...
class Artmuseum_Quote_Section extends Widget_Base {
	...
	public function get_title() {
		return __( 'Quote Section', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Quote Section', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'quotesect_contleft',
            [
                'label' => esc_html__( 'Content Left', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'quotesect_contright',
            [
                'label' => esc_html__( 'Content Right', 'artmuseum-companion' ),
                'type'  => Controls_Manager::WYSIWYG,
            ]
        );
        ...
        $this->start_controls_section(
            'style_desc', [
                'label' => __( 'Style Description', 'artmuseum-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_leftcontent', [
                'label'     => __( 'Content Left', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'color_rightcontent', [
                'label'     => __( 'Content Right', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777777',
                'selectors' => [
