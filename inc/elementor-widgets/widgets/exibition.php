...
class Artmuseum_Exibition extends Widget_Base {
	...
	public function get_title() {
		return __( 'Exibition', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'exibition_heading',
            [
                'label' => __( 'Exibition Section Heading', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
        ...
        $this->add_control(
            'sect_subtitle', [
                'label' => __( 'Sub Title', 'artmuseum-companion' ),
                'type'  => Controls_Manager::TEXT,
                'label_block' => true
		...
		$this->start_controls_section(
			'exibition_content',
			[
				'label' => __( 'Exibition', 'artmuseum-companion' ),
			]
		);
		$this->add_control(
            'exibition_slider', [
                'label' => __( 'Create Exibition', 'artmuseum-companion' ),
                'type'  => Controls_Manager::REPEATER,
                'title_field' => '{{{ label }}}',
                'fields' => [
                    [
                        'name'  => 'label',
                        'label' => __( 'Name', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true,
                        'default' => 'Name'
                    ],
                    [
                        'name'  => 'url',
                        'label' => __( 'Title Url', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::URL,
                        'show_external' => false,
                    ],
                    [
                        'name'  => 'date',
                        'label' => __( 'Date', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::DATE_TIME,
                        'default' => ''
                    ],
                    [
                        'name'  => 'category',
                        'label' => __( 'Categories', 'artmuseum-companion' ),
                        'description' => esc_html__( 'Add exibition categories like this format: Travel,Life style', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::TEXT,
                        'label_block' => true
                    ],
                    [
                    ...
                    [
                        'name'  => 'img',
                        'label' => __( 'Photo', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'color_secttitle', [
                'label'     => __( 'Section Title Color', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'color_sectsubtitle', [
                'label'     => __( 'Section Sub Title Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#777',
                'selectors' => [
