...
class Artmuseum_Exhibitions_Ticket extends Widget_Base {
	...
	public function get_title() {
		return __( 'Exhibitions Ticket', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'exhitic_heading',
            [
                'label' => __( 'Exhibitions Ticket Section Heading', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'exhitic_contents',
			[
				'label' => __( 'Exhibitions Ticket', 'artmuseum-companion' ),
			]
		);
		$this->add_control(
            'ticket_content', [
                'label' => __( 'Create Ticket', 'artmuseum-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'price',
                        'label' => __( 'Price', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::TEXT
                    ],
                    [
                        'name'  => 'desc',
