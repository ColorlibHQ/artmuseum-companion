...
class Artmuseum_Banner extends Widget_Base {
	...
	public function get_title() {
		return __( 'Banner', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'banner_content',
            [
                'label' => __( 'Banner Section Content', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'banner_titleone',
            [
                'label'         => esc_html__( 'Title #1', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'banner_titletwo',
            [
                'label'         => esc_html__( 'Title #2', 'artmuseum-companion' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true
            ]
        );
        $this->add_control(
            'banner_desc',
            [
                'label'         => esc_html__( 'Description', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'banner_btnlabel',
            [
                'label'         => esc_html__( 'Button Label', 'artmuseum-companion' ),
                'type'          => Controls_Manager::TEXT,
                'label_block'   => true,
                'default'       => esc_html__( 'Explore Us', 'artmuseum-companion' )
            ]
        );
        $this->add_control(
            'banner_btnurl',
            [
                'label'         => esc_html__( 'Button Url', 'artmuseum-companion' ),
        ...
        $this->start_controls_section(
            'style_textcolor', [
                'label' => __( 'Style Content', 'artmuseum-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_titleone', [
                'label'     => __( 'Title #1 Color', 'artmuseum-companion' ),
        ...
        $this->add_control(
            'color_titletwo', [
                'label'     => __( 'Title #2 Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_desc', [
                'label'     => __( 'Description Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->start_controls_section(
            'style_btn', [
                'label' => __( 'Style Button', 'artmuseum-companion' ),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_control(
            'color_btnlabel', [
                'label'     => __( 'Button Label Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#fff',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhoverlabel', [
                'label'     => __( 'Button Hover Label Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#88d200',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnborder', [
                'label'     => __( 'Button Border Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#88d200',
                'selectors' => [
        ...
        $this->add_control(
            'color_btnhovborder', [
                'label'     => __( 'Button Hover Border Color', 'artmuseum-companion' ),
                'type'      => Controls_Manager::COLOR,
                'default'   => '#88d200',
                'selectors' => [
