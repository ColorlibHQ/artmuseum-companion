...
class Artmuseum_Events extends Widget_Base {
	...
	public function get_title() {
		return __( 'Events', 'artmuseum-companion' );
	}
	...
	protected function _register_controls() {
        ...
        $this->start_controls_section(
            'events_heading',
            [
                'label' => __( 'Events Section Heading', 'artmuseum-companion' ),
            ]
        );
        $this->add_control(
            'sect_title', [
		...
		$this->start_controls_section(
			'events_content',
			[
				'label' => __( 'Events', 'artmuseum-companion' ),
			]
		);
		$this->add_control(
            'events_content_rep', [
                'label' => __( 'Create events', 'artmuseum-companion' ),
                ...
                'fields' => [
                    ...
                    [
                        'name'  => 'location',
                        'label' => __( 'Location', 'artmuseum-companion' ),
                        'type'  => Controls_Manager::TEXT,
                    ...
                    [
                        'name'  => 'img',
                        'label' => __( 'Image', 'artmuseum-companion' ),
                ...
                ?>
                    <div class="col-lg-6<?php echo esc_attr( $eventClass ); ?>">
                        <div class="single-events">
                            ...
                            echo sprintf( '<h6>%s %s %s</h6>', $date, __( 'at', 'artmuseum-companion' ), $location );
                            // Content
                            if( !empty( $val['desc'] ) ){
